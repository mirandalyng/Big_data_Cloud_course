...
BASE_DIR = "/Volumes/airbnb/default/raw"
...
schema = (
    ...
    .load(f"{BASE_DIR}/data/Airbnb_Open_Data.csv")
    .schema
)

# This will create a streaming table 
# Supply-cataloge --> bronze schema --> raw supply chain (table)
@dp.table(name="airbnb.bronze.raw_supply_chain", comment ="Raw supply chain data for Airbnb", table_properties={
